...
> **Given Information**
  1. username: bandit3
  2. password from level 3: REDACTED
  3. ssh port: 2220
...
> **Moral of the Story**
- You need to understand how Linux Systems hide files, the way you can view them as well as how to handle weird naming as well
